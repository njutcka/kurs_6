...
class Mailing(models.Model):
    ...
    status_mail = models.CharField(max_length=25, choices=STATUS_CHOICES,verbose_name='Статус рассылки') #создана, запущена, выполнена
...
class Logfile(models.Model):
    ...
    status_log = models.BooleanField(verbose_name='статус попытки', choices=STATUS_CHOICES)
